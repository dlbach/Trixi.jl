...
@muladd begin
    ...
    @inline function calcflux_fv!(
        ...
        for j in eachnode(dg)
            normal_direction =
                get_contravariant_vector(1, contravariant_vectors, 1, j, element)
            ...
            for i = 2:nnodes(dg)
                ...
                for m = 1:nnodes(dg)
                    normal_direction +=
                        ...
                        get_contravariant_vector(1, contravariant_vectors, m, j, element)
                end
        ...
        for i in eachnode(dg)
            normal_direction =
                get_contravariant_vector(2, contravariant_vectors, i, 1, element)
            ...
            for j = 2:nnodes(dg)
                ...
                for m = 1:nnodes(dg)
                    normal_direction +=
                        ...
                        get_contravariant_vector(2, contravariant_vectors, i, m, element)
                end
    ...
    @inline function calc_interface_flux!(
        ...
        for i in eachnode(dg)
            if orientation == 1
                ...
                normal_direction =
                    sign_jacobian *
                    get_contravariant_vector(1, contravariant_vectors, 1, i, right_element)
            else # orientation == 2
                ...
                normal_direction =
                    sign_jacobian *
                    get_contravariant_vector(2, contravariant_vectors, i, 1, right_element)
            end
    ...
    @inline function calc_interface_flux!(
        ...
        for i in eachnode(dg)
            ...
            for v in eachvariable(equations)
                ...
                # the interpretation of global SBP operators coupled discontinuously via
                # central fluxes/SATs
                surface_flux_values[v, i, right_direction, left_element] =
                    flux[v] + 0.5 * noncons_left[v]
                surface_flux_values[v, i, left_direction, right_element] =
