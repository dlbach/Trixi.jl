...
@muladd begin
    ...
    function calc_volume_integral!(
        ...
        @threaded for element in eachelement(dg, cache)
            ...
            for i in eachnode(dg)
                flux_1_node =
                    get_node_vars(flux_viscous, equations_parabolic, dg, i, element)
    ...
    function calc_viscous_fluxes!(
        ...
        @threaded for element in eachelement(dg, cache)
            for i in eachnode(dg)
                ...
                gradients_1_node =
                    get_node_vars(gradients, equations_parabolic, dg, i, element)
    ...
    function calc_gradient!(
        ...
        @trixi_timeit timer() "volume integral" begin
            ...
            @threaded for element in eachelement(dg, cache)
                ...
                for i in eachnode(dg)
                    u_node =
                        get_node_vars(u_transformed, equations_parabolic, dg, i, element)
