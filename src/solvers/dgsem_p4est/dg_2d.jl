...
@muladd begin
    ...
    function create_cache(
        ...
        u_threaded = MA2d[MA2d(undef) for _ = 1:Threads.nthreads()]
    ...
    function prolong2interfaces!(
        ...
        @threaded for interface in eachinterface(dg, cache)
            ...
            i_primary_start, i_primary_step =
                index_to_start_step_2d(primary_indices[1], index_range)
            j_primary_start, j_primary_step =
                index_to_start_step_2d(primary_indices[2], index_range)

            i_primary = i_primary_start
            j_primary = j_primary_start
            for i in eachnode(dg)
                for v in eachvariable(equations)
                    interfaces.u[1, v, i, interface] =
                        u[v, i_primary, j_primary, primary_element]
                end
            ...
            i_secondary_start, i_secondary_step =
                index_to_start_step_2d(secondary_indices[1], index_range)
            j_secondary_start, j_secondary_step =
                index_to_start_step_2d(secondary_indices[2], index_range)

            i_secondary = i_secondary_start
            j_secondary = j_secondary_start
            for i in eachnode(dg)
                for v in eachvariable(equations)
                    interfaces.u[2, v, i, interface] =
                        u[v, i_secondary, j_secondary, secondary_element]
                end
    ...
    @inline function calc_interface_flux!(
        ...
        u_ll, u_rr =
            get_surface_node_vars(u, equations, dg, primary_node_index, interface_index)
    ...
    @inline function calc_boundary_flux!(
        surface_flux_values,
        t,
        boundary_condition,
        mesh::P4estMesh{2},
    ...
    @inline function calc_boundary_flux!(
        ...
        for v in eachvariable(equations)
            ...
            # the interpretation of global SBP operators coupled discontinuously via
            # central fluxes/SATs
            surface_flux_values[v, node_index, direction_index, element_index] =
                flux_[v] + 0.5 * noncons_[v]
        end
    end
    ...
    function prolong2mortars!(
        ...
        @threaded for mortar in eachmortar(dg, cache)
            ...
            i_small_start, i_small_step =
                index_to_start_step_2d(small_indices[1], index_range)
            j_small_start, j_small_step =
                index_to_start_step_2d(small_indices[2], index_range)
            ...
            for position = 1:2
                ...
                for i in eachnode(dg)
                    for v in eachvariable(equations)
                        cache.mortars.u[1, v, position, i, mortar] =
                            u[v, i_small, j_small, element]
                    end
            ...
            i_large_start, i_large_step =
                index_to_start_step_2d(large_indices[1], index_range)
            j_large_start, j_large_step =
                index_to_start_step_2d(large_indices[2], index_range)
    ...
    function calc_mortar_flux!(
        ...
        @threaded for mortar in eachmortar(dg, cache)
            ...
            fstar = (
                fstar_lower_threaded[Threads.threadid()],
    ...
    @inline function mortar_fluxes_to_elements!(
        ...
        for position = 1:2
            ...
            for i in eachnode(dg)
                for v in eachvariable(equations)
                    surface_flux_values[v, i, small_direction, element] =
                        fstar[position][v, i]
                end
            end
        end
        ...
        if :i_backward in large_indices
            for i in eachnode(dg)
                for v in eachvariable(equations)
                    surface_flux_values[v, end+1-i, large_direction, large_element] =
                        u_buffer[v, i]
                end
            end
        else
            for i in eachnode(dg)
                for v in eachvariable(equations)
                    surface_flux_values[v, i, large_direction, large_element] =
                        u_buffer[v, i]
                end
            end
        end
