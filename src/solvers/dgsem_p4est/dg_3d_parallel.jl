...
@muladd begin
    ...
    function prolong2mpiinterfaces!(
        ...
        @threaded for interface in eachmpiinterface(dg, cache)
            ...
            i_element_start, i_element_step_i, i_element_step_j =
                index_to_start_step_3d(local_indices[1], index_range)
            j_element_start, j_element_step_i, j_element_step_j =
                index_to_start_step_3d(local_indices[2], index_range)
            k_element_start, k_element_step_i, k_element_step_j =
                index_to_start_step_3d(local_indices[3], index_range)
            ...
            for j in eachnode(dg)
                for i in eachnode(dg)
                    for v in eachvariable(equations)
                        mpi_interfaces.u[local_side, v, i, j, interface] =
                            u[v, i_element, j_element, k_element, local_element]
                    end
    ...
    function calc_mpi_interface_flux!(
        ...
        @threaded for interface in eachmpiinterface(dg, cache)
            ...
            i_surface_start, i_surface_step_i, i_surface_step_j =
                index_to_start_step_3d(local_surface_indices[1], index_range)
            j_surface_start, j_surface_step_i, j_surface_step_j =
                index_to_start_step_3d(local_surface_indices[2], index_range)
            ...
            for (element, position) in zip(local_neighbor_ids, local_neighbor_positions)
                if position == 5 # -> large element
                    ...
                    multiply_dimensionwise!(
                        view(cache.mpi_mortars.u, 2, :, 1, :, :, mortar),
                    ...
                    multiply_dimensionwise!(
                        view(cache.mpi_mortars.u, 2, :, 2, :, :, mortar),
                    ...
                    multiply_dimensionwise!(
                        view(cache.mpi_mortars.u, 2, :, 3, :, :, mortar),
                        mortar_l2.forward_lower,
                        mortar_l2.forward_upper,
                        u_buffer,
                        fstar_tmp,
                    ...
                    multiply_dimensionwise!(
                        view(cache.mpi_mortars.u, 2, :, 4, :, :, mortar),
                        mortar_l2.forward_upper,
                        mortar_l2.forward_upper,
                        u_buffer,
                        fstar_tmp,
    ...
    function calc_mpi_mortar_flux!(
        ...
        @unpack local_neighbor_ids, local_neighbor_positions, node_indices =
            cache.mpi_mortars
        @unpack contravariant_vectors = cache.elements
            ...
            for position = 1:4
                ...
                for j in eachnode(dg)
                    for i in eachnode(dg)
                        ...
                        normal_direction =
                            get_normal_direction(cache.mpi_mortars, i, j, position, mortar)
    ...
    @inline function calc_mpi_mortar_flux!(
        fstar,
        mesh::ParallelP4estMesh{3},
        nonconservative_terms::False,
        equations,
