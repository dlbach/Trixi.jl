...
function calc_gradient!(
    ...
    @trixi_timeit timer() "volume integral" begin
        ...
        @threaded for element in eachelement(dg, cache)
            ...
            for j in eachnode(dg), i in eachnode(dg)
                Ja11, Ja12 =
                    get_contravariant_vector(1, contravariant_vectors, i, j, element)
                Ja21, Ja22 =
                    get_contravariant_vector(2, contravariant_vectors, i, j, element)

                gradients_reference_1 =
                    get_node_vars(gradients_x, equations_parabolic, dg, i, j, element)
                gradients_reference_2 =
                ...
                gradient_x_node =
                    Ja11 * gradients_reference_1 + Ja21 * gradients_reference_2
                gradient_y_node =
    ...
    @trixi_timeit timer() "interface flux" calc_interface_flux!(
        ...
        mesh,
        False(), # False() = no nonconservative terms
        equations_parabolic,
        dg.surface_integral,
        dg,
        cache_parabolic,
        ...
        @threaded for element in eachelement(dg, cache)
            for l in eachnode(dg)
                for v in eachvariable(equations_parabolic)
                    ...
                    # surface at -x
                    normal_direction_x, _ =
                        get_normal_direction(1, contravariant_vectors, 1, l, element)
                    ...
                    # surface at +x
                    normal_direction_x, _ = get_normal_direction(
                        2,
                    ...
                    # surface at -y
                    normal_direction_x, _ =
                        get_normal_direction(3, contravariant_vectors, l, 1, element)
    ...
    @threaded for interface in eachinterface(dg, cache)
        ...
        for i in eachnode(dg)
            ...
            for v in eachvariable(equations_parabolic)
                ...
                flux_viscous = SVector(
                    flux_viscous_x[v, i_primary, j_primary, primary_element],
        ...
        for i in eachnode(dg)
            ...
            for v in eachvariable(equations_parabolic)
                # OBS! `interfaces.u` stores the interpolated *fluxes* and *not the solution*!
                flux_viscous = SVector(
                    flux_viscous_x[v, i_secondary, j_secondary, secondary_element],
...
function calc_interface_flux!(
    ...
    @threaded for interface in eachinterface(dg, cache_parabolic)
        ...
        for node in eachnode(dg)
            ...
            viscous_flux_normal_ll, viscous_flux_normal_rr = get_surface_node_vars(
