...
@muladd begin
    ...
    function cons2entropy!(
        ...
        rho_values, rho_v1_values, rho_v2_values, rho_e_values =
            StructArrays.components(u_values)
        w1_values, w2_values, w3_values, w4_values =
            StructArrays.components(entropy_var_values)
    ...
    function entropy2cons!(
        ...
        rho_values, rho_v1_values, rho_v2_values, rho_e_values =
            StructArrays.components(entropy_projected_u_values)
        w1_values, w2_values, w3_values, w4_values =
            StructArrays.components(projected_entropy_var_values)
        ...
        @turbo thread = true for i in eachindex(
            ...
            # eq. (52)
            rho_iota =
                (gamma_minus_one / (-w4)^gamma)^(inv_gamma_minus_one) *
    ...
    function entropy2cons!(
        ...
        @turbo thread = true for i in eachindex(
            ...
            # eq. (52)
            rho_iota =
                (gamma_minus_one / (-w5)^gamma)^(inv_gamma_minus_one) *
                exp(-s * inv_gamma_minus_one)
