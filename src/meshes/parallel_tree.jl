...
@muladd begin
    ...
    ParallelTree{1}(cap::Int, center::Real, len::Real, periodicity = true) =
    ...
    function init_child!(t::ParallelTree, cell_id, child, child_id)
        ...
        set_cell_coordinates!(
            ...
            child_coordinates(
                t,
                cell_coordinates(t, cell_id),
                length_at_cell(t, cell_id),
                child,
            ),
            child_id,
        )
    ...
    function raw_copy!(
        ...
        copy_data!(
            target.original_cell_ids,
            source.original_cell_ids,
            first,
            last,
            destination,
        )
