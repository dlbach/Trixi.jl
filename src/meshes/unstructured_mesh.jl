...
@muladd begin
        ...
        for j = 1:n_elements
            ...
            if sum(curved_check) == 0
                ...
                for i = 1:4
                    ...
                    surface_curves[i, j] =
                        CurvedSurfaceT(cheby_nodes, bary_weights, copy(curve_values))
    ...
    function Base.show(
        io::IO,
        ::UnstructuredMesh2D{RealT,CurvedSurfaceT},
    ) where {RealT,CurvedSurfaceT}
    ...
    function Base.show(
        io::IO,
        ::MIME"text/plain",
        mesh::UnstructuredMesh2D{RealT,CurvedSurfaceT},
    ) where {RealT,CurvedSurfaceT}
