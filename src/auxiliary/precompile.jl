...
function _precompile_manual_()
    ...
    for RealT in (Int, Float64)
        @assert Base.precompile(
            Tuple{
                Core.kwftype(typeof(Trixi.Type)),
                NamedTuple{(:initial_refinement_level, :n_cells_max),Tuple{Int,Int}},
                Type{TreeMesh},
                RealT,
                RealT,
            },
    ...
    for TreeType in (SerialTree, ParallelTree), NDIMS = 1:3
        @assert Base.precompile(
            Tuple{
                typeof(Trixi.initialize!),
                TreeMesh{NDIMS,TreeType{NDIMS}},
                Int,
                Tuple{},
                Tuple{},
            },
        ...
        @assert Base.precompile(
            Tuple{typeof(Trixi.save_mesh_file),TreeMesh{NDIMS,TreeType{NDIMS}},String,Int},
        )
    end
    ...
    for RealT in (Float64,)
        ...
        @assert Base.precompile(
            Tuple{Type{LinearScalarAdvectionEquation2D},Tuple{RealT,RealT}},
        )
        @assert Base.precompile(
            Tuple{Type{LinearScalarAdvectionEquation3D},RealT,RealT,RealT},
        )
        @assert Base.precompile(
            Tuple{Type{LinearScalarAdvectionEquation3D},Tuple{RealT,RealT,RealT}},
        )
    end
    ...
    for RealT in (Float64,)
        ...
        @assert Base.precompile(
            Tuple{typeof(Trixi.calc_dsplit),Vector{RealT},Vector{RealT}},
        )
        @assert Base.precompile(
            Tuple{typeof(Trixi.polynomial_derivative_matrix),Vector{RealT}},
        )
        @assert Base.precompile(
            Tuple{
                typeof(Trixi.polynomial_interpolation_matrix),
                Vector{RealT},
                Vector{RealT},
            },
        )
        ...
        @assert Base.precompile(
            Tuple{typeof(Trixi.calc_lhat),RealT,Vector{RealT},Vector{RealT}},
        )
        @assert Base.precompile(
            Tuple{
                typeof(Trixi.lagrange_interpolating_polynomials),
                RealT,
                Vector{RealT},
                Vector{RealT},
            },
        ...
        @assert Base.precompile(
            Tuple{typeof(Trixi.legendre_polynomial_and_derivative),Int,RealT},
        )
    ...
    for RealT in (Float64,), polydeg = 1:7
        nnodes_ = polydeg + 1
    ...
    @assert Base.precompile(
        Tuple{
            Core.kwftype(typeof(Trixi.Type)),
            NamedTuple{(:interval, :save_final_restart),Tuple{Int,Bool}},
            Type{SaveRestartCallback},
        },
    )
    @assert Base.precompile(
        Tuple{
    ...
    @assert Base.precompile(
        Tuple{typeof(summary_box),Base.TTY,String,Vector{Pair{String,Any}}},
    )
    ...
    for RealT in (Float64,), polydeg = 1:7
        ...
        @assert Base.precompile(
            Tuple{typeof(Trixi.save_mesh_file),TreeMesh{1,Trixi.SerialTree{1}},String},
        )
        ...
        @assert Base.precompile(
            Tuple{typeof(Trixi.save_mesh_file),TreeMesh{2,Trixi.SerialTree{2}},String},
        )
        ...
        @assert Base.precompile(
            Tuple{
                typeof(Trixi.init_mpi_interfaces),
                Array{Int,1},
                TreeMesh{2,Trixi.ParallelTree{2}},
                Trixi.ElementContainer2D{RealT,uEltype},
            },
        ...
        @assert Base.precompile(
            Tuple{typeof(Trixi.save_mesh_file),TreeMesh{2,Trixi.ParallelTree{2}},String},
        )
        ...
        @assert Base.precompile(
            Tuple{typeof(Trixi.save_mesh_file),TreeMesh{3,Trixi.SerialTree{3}},String},
        )
    end
    ...
    for RealT in (Float64,)
        ...
        for NDIMS = 1:3
            # serial
            @assert Base.precompile(
                Tuple{typeof(show),Base.TTY,TreeMesh{NDIMS,Trixi.SerialTree{NDIMS}}},
            )
            @assert Base.precompile(
                Tuple{
                    typeof(show),
            ...
            # parallel
            @assert Base.precompile(
                Tuple{typeof(show),Base.TTY,TreeMesh{NDIMS,Trixi.ParallelTree{NDIMS}}},
            )
            @assert Base.precompile(
                Tuple{
                    typeof(show),
        ...
        for eq_type in equations_types(RealT)
            ...
            @assert Base.precompile(
                Tuple{typeof(show),IOContext{Base.TTY},MIME"text/plain",eq_type},
            )
        end
        ...
        for polydeg = 1:1
            ...
            @assert Base.precompile(
                Tuple{typeof(show),IOContext{Base.TTY},MIME"text/plain",basis_type},
            )

            @assert Base.precompile(Tuple{typeof(show),Base.TTY,mortar_type})
            @assert Base.precompile(
                Tuple{typeof(show),IOContext{Base.TTY},MIME"text/plain",mortar_type},
            )

            @assert Base.precompile(Tuple{typeof(show),Base.TTY,analyzer_type})
            @assert Base.precompile(
                Tuple{typeof(show),IOContext{Base.TTY},MIME"text/plain",analyzer_type},
            )

            @assert Base.precompile(Tuple{typeof(show),Base.TTY,adaptor_type})
            @assert Base.precompile(
                Tuple{typeof(show),IOContext{Base.TTY},MIME"text/plain",adaptor_type},
            )
        ...
        # callbacks
        summary_callback_type = DiscreteCallback{
            typeof(Trixi.summary_callback),
            typeof(Trixi.summary_callback),
            typeof(Trixi.initialize_summary_callback),
            typeof(SciMLBase.FINALIZE_DEFAULT),
        ...
        @assert Base.precompile(
            Tuple{typeof(show),IOContext{Base.TTY},MIME"text/plain",summary_callback_type},
        )
        @assert Base.precompile(Tuple{summary_callback_type,Base.TTY})

        # TODO: SteadyStateCallback, AnalysisCallback

        alive_callback_type = DiscreteCallback{
            AliveCallback,
            AliveCallback,
            typeof(Trixi.initialize!),
            typeof(SciMLBase.FINALIZE_DEFAULT),
        ...
        @assert Base.precompile(
            Tuple{typeof(show),IOContext{Base.TTY},MIME"text/plain",alive_callback_type},
        )

        restart_callback_type = DiscreteCallback{
            SaveRestartCallback,
            SaveRestartCallback,
            typeof(Trixi.initialize!),
            typeof(SciMLBase.FINALIZE_DEFAULT),
        ...
        @assert Base.precompile(
            Tuple{typeof(show),IOContext{Base.TTY},MIME"text/plain",restart_callback_type},
        )
        ...
        for solution_variables in (cons2cons, cons2prim)
            ...
            @assert Base.precompile(
                Tuple{typeof(show),Base.TTY,save_solution_callback_type},
            )
            @assert Base.precompile(
                Tuple{
                    typeof(show),
        ...
        stepsize_callback_type = DiscreteCallback{
        ...
        @assert Base.precompile(
            Tuple{typeof(show),IOContext{Base.TTY},MIME"text/plain",stepsize_callback_type},
        )

        glm_speed_callback_type = DiscreteCallback{
        ...
        lbm_collision_callback_type = DiscreteCallback{
