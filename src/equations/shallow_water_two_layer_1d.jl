...
@muladd begin
    ...
    * Trixi's visualization tools will visualize the bottom topography by default.
    ...
    function ShallowWaterTwoLayerEquations1D(;
        gravity_constant,
    ...
    varnames(::typeof(cons2cons), ::ShallowWaterTwoLayerEquations1D) =
        ("h_upper", "h_v1_upper", "h_lower", "h_v1_lower", "b")
    ...
    # conditions
    varnames(::typeof(cons2prim), ::ShallowWaterTwoLayerEquations1D) =
        ("H_upper", "v1_upper", "H_lower", "v1_lower", "b")
    ...
    @inline function source_terms_convergence_test(
        ...
        du1 = (
            -0.1 * cos(t + ω * x[1]) - 0.1 * sin(t + ω * x[1]) -
            0.09 * ω * cos(t + ω * x[1]) + -0.09 * ω * sin(t + ω * x[1])
        )
        du2 = (
            5.0 *
            (-0.1 * ω * cos(t + ω * x[1]) - 0.1 * ω * sin(t + ω * x[1])) *
            (4.0 + 0.2 * cos(t + ω * x[1]) + -0.2 * sin(t + ω * x[1])) +
            0.1 * ω * (20.0 + cos(t + ω * x[1]) - sin(t + ω * x[1])) * cos(t + ω * x[1]) - 0.09 * cos(t + ω * x[1]) - 0.09 * sin(t + ω * x[1]) -
            0.081 * ω * cos(t + ω * x[1]) + -0.081 * ω * sin(t + ω * x[1])
        )
        du3 =
            0.1 * cos(t + ω * x[1]) +
            0.1 * ω * cos(t + ω * x[1]) +
        ...
        du4 = (
            ...
            0.1 * ω * cos(t + ω * x[1]) +
            5.0 *
            (0.1 * ω * cos(t + ω * x[1]) + 0.2 * ω * sin(2.0 * ω * x[1])) *
            (2.0 + 0.2 * sin(t + ω * x[1]) + -0.2 * cos(2.0 * ω * x[1])) +
            0.2 * ω * sin(2.0 * ω * x[1])
        )
    ...
    @inline function flux_es_fjordholm_etal(
        ...
        f_ec = flux_fjordholm_etal(u_ll, u_rr, orientation, equations)
    ...
    @inline entropy(cons, equations::ShallowWaterTwoLayerEquations1D) =
    ...
    @inline function energy_total(cons, equations::ShallowWaterTwoLayerEquations1D)
        ...
        e = (
            0.5 * rho_upper * (h_v1_upper^2 / h_upper + g * h_upper^2) +
