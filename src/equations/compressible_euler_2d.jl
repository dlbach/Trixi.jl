...
@muladd begin
    ...
    varnames(::typeof(cons2cons), ::CompressibleEulerEquations2D) =
    ...
    in combination with [`initial_condition_eoc_test_coupled_euler_gravity`](@ref).
    """
    @inline function source_terms_eoc_test_euler(
        u,
        x,
        t,
        equations::CompressibleEulerEquations2D,
    ...
    !!! warning "Experimental implementation (upwind SBP)"
        This is an experimental feature and may change in future releases.
    """
    @inline function splitting_lax_friedrichs(
        u,
        orientation::Integer,
        equations::CompressibleEulerEquations2D,
    )
    ...
    @inline function rotate_to_x(u, normal_vector, equations::CompressibleEulerEquations2D)
        ...
        return SVector(u[1], c * u[2] + s * u[3], -s * u[2] + c * u[3], u[4])
    end
    ...
    @inline entropy(cons, equations::CompressibleEulerEquations2D) =
