...
@muladd begin
    ...
    function x_trans_periodic_2d(x, domain_length = SVector(10, 10), center = SVector(0, 0))
        ...
        x_offset =
            ((x_shifted .< -0.5 * domain_length) - (x_shifted .> 0.5 * domain_length)) .*
            domain_length
    ...
    """
    function boundary_condition_linear_x_y(
        u_inner,
        orientation,
        direction,
        x,
    ...
    """
    function boundary_condition_linear_x(
        u_inner,
        orientation,
        direction,
        x,
    ...
    """
    function boundary_condition_linear_y(
        u_inner,
        orientation,
        direction,
        x,
    ...
    @inline energy_total(u, equation::LinearScalarAdvectionEquation2D) =
