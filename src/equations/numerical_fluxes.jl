...
@muladd begin
    ...
    @inline function (numflux::FluxPlusDissipation)(
        u_ll,
        u_rr,
        orientation_or_normal_direction,
        equations,
        ...
        return (
            numerical_flux(u_ll, u_rr, orientation_or_normal_direction, equations) +
            dissipation(u_ll, u_rr, orientation_or_normal_direction, equations)
        )
    end

    Base.show(io::IO, f::FluxPlusDissipation) =
    ...
    @inline function (flux_rotated::FluxRotated)(
        u_ll,
        u_rr,
    ...
    Base.show(io::IO, d::DissipationGlobalLaxFriedrichs) =
    ...
    Base.show(io::IO, d::DissipationLocalLaxFriedrichs) =
    ...
    const FluxLaxFriedrichs{MaxAbsSpeed} =
        FluxPlusDissipation{typeof(flux_central),DissipationLocalLaxFriedrichs{MaxAbsSpeed}}
    """
    ...
    Base.show(io::IO, f::FluxLaxFriedrichs) =
    ...
    @inline function (numflux::FluxHLL)(
        u_ll,
        u_rr,
        orientation_or_normal_direction,
        equations,
        ...
        λ_min, λ_max =
            numflux.min_max_speed(u_ll, u_rr, orientation_or_normal_direction, equations)
    ...
    """
    @inline function flux_shima_etal_turbo(
        u_ll,
        u_rr,
        orientation_or_normal_direction,
        equations,
    ...
    increase runtime efficiency on modern hardware.
    """
    @inline function flux_ranocha_turbo(
        u_ll,
        u_rr,
        orientation_or_normal_direction,
        equations,
    ...
    @inline function (numflux::FluxHydrostaticReconstruction)(
        u_ll,
        u_rr,
        orientation_or_normal_direction,
        equations::AbstractEquations,
