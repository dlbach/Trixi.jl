...
"""
struct CompressibleNavierStokesDiffusion2D{
    GradientVariables,
    RealT<:Real,
...
function CompressibleNavierStokesDiffusion2D(
...
gradient_variable_transformation(
    ::CompressibleNavierStokesDiffusion2D{GradientVariablesEntropy},
) = cons2entropy
...
cons2entropy(u, equations::CompressibleNavierStokesDiffusion2D) =
    cons2entropy(u, equations.equations_hyperbolic)
entropy2cons(w, equations::CompressibleNavierStokesDiffusion2D) =
