...
@muladd begin
    ...
    default_analysis_errors(::HyperbolicDiffusionEquations2D) =
    ...
    @inline function initial_condition_poisson_nonperiodic(
        x,
        t,
    ...
    @inline function boundary_condition_poisson_nonperiodic(
        u_inner,
        orientation,
        direction,
        x,
    ...
    @inline entropy(u, equations::HyperbolicDiffusionEquations2D) =
