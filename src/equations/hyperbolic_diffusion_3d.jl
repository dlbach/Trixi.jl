...
@muladd begin
    ...
    varnames(::typeof(cons2cons), ::HyperbolicDiffusionEquations3D) =
        ("phi", "q1", "q2", "q3")
    varnames(::typeof(cons2prim), ::HyperbolicDiffusionEquations3D) =
        ("phi", "q1", "q2", "q3")
    default_analysis_errors(::HyperbolicDiffusionEquations3D) =
    ...
    function initial_condition_poisson_nonperiodic(
        x,
        t,
    ...
    function boundary_condition_poisson_nonperiodic(
        u_inner,
        orientation,
        direction,
        x,
    ...
    """
    @inline function source_terms_harmonic(
        u,
        x,
        t,
        equations::HyperbolicDiffusionEquations3D,
    ...
    @inline entropy(u, equations::HyperbolicDiffusionEquations3D) =
