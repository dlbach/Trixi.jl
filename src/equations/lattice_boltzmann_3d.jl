...
@muladd begin
    ...
    * 27 ←→ 27
    ...
    function LatticeBoltzmannEquations3D(;
        Ma,
        Re,
    ...
    varnames(::typeof(cons2cons), equations::LatticeBoltzmannEquations3D) =
        ntuple(v -> "pdf" * string(v), Val(nvariables(equations)))
    varnames(::typeof(cons2prim), equations::LatticeBoltzmannEquations3D) =
    ...
    varnames(::typeof(cons2macroscopic), ::LatticeBoltzmannEquations3D) =
        ("rho", "v1", "v2", "v3", "p")
    ...
    `u`.
    """
    @inline pressure(rho::Real, equations::LatticeBoltzmannEquations3D) =
        rho * equations.c_s^2
    @inline pressure(u, equations::LatticeBoltzmannEquations3D) =
    ...
    @inline function equilibrium_distribution(
        ...
        return SVector(
            equilibrium_distribution(1, rho, v1, v2, v3, equations),
    ...
    @inline function energy_kinetic_nondimensional(
        u,
        equations::LatticeBoltzmannEquations3D,
    )
