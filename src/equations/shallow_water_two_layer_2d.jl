...
@muladd begin
    ...
    * Trixi's visualization tools will visualize the bottom topography by default.
    ...
    function ShallowWaterTwoLayerEquations2D(;
        gravity_constant,
        ...
        if rho_upper > rho_lower
            error(
                "Invalid input: Densities must be chosen such that rho_upper <= rho_lower",
            )
        else
    ...
    function initial_condition_convergence_test(
        ...
        return prim2cons(
            SVector(H_upper, v1_upper, v2_upper, H_lower, v1_lower, v2_lower, b),
            equations,
        )
    end
    ...
    """
    @inline function source_terms_convergence_test(
        u,
        x,
        t,
        equations::ShallowWaterTwoLayerEquations2D,
    ...
    - Eleuterio F. Toro (2001)
      ...
      ISBN 0471987662
    """
    @inline function boundary_condition_slip_wall(
        u_inner,
    ...
    """
    @inline function flux_nonconservative_wintermeyer_etal(
        u_ll,
        u_rr,
        orientation::Integer,
        equations::ShallowWaterTwoLayerEquations2D,
    ...
    @inline function flux_nonconservative_wintermeyer_etal(
        ...
        return SVector(
            zero(eltype(u_ll)),
            normal_direction_average[1] *
            equations.gravity *
            h_upper_ll *
            (b_rr + h_lower_rr),
            normal_direction_average[2] *
            equations.gravity *
            h_upper_ll *
            (b_rr + h_lower_rr),
            zero(eltype(u_ll)),
    ...
    formulation.
    """
    @inline function flux_nonconservative_fjordholm_etal(
        u_ll,
        u_rr,
        orientation::Integer,
        equations::ShallowWaterTwoLayerEquations2D,
        ...
        if orientation == 1
            f = SVector(
                ...
                g * h_lower_average * (b_jump + equations.r * h_upper_jump),
                z,
                z,
            )
        else # orientation == 2
    ...
    @inline function flux_nonconservative_fjordholm_etal(
        ...
        f2 +=
            normal_direction_ll[1] *
            equations.gravity *
            h_upper_average *
            (b_jump + h_lower_jump)
        f3 +=
            normal_direction_ll[2] *
            equations.gravity *
            h_upper_average *
            (b_jump + h_lower_jump)
        f5 +=
    ...
    formulation.
    """
    @inline function flux_fjordholm_etal(
        u_ll,
        u_rr,
        orientation::Integer,
        equations::ShallowWaterTwoLayerEquations2D,
    ...
    @inline function flux_fjordholm_etal(
        ...
        v_upper_dot_n_ll =
            v1_upper_ll * normal_direction[1] + v2_upper_ll * normal_direction[2]
        v_upper_dot_n_rr =
            v1_upper_rr * normal_direction[1] + v2_upper_rr * normal_direction[2]
        v_lower_dot_n_ll =
            v1_lower_ll * normal_direction[1] + v2_lower_ll * normal_direction[2]
        v_lower_dot_n_rr =
            v1_lower_rr * normal_direction[1] + v2_lower_rr * normal_direction[2]
    ...
    - Niklas Wintermeyer, Andrew R. Winters, Gregor J. Gassner and David A. Kopriva (2017)
      ...
      [DOI: 10.1016/j.jcp.2017.03.036](https://doi.org/10.1016/j.jcp.2017.03.036)
    """
    @inline function flux_wintermeyer_etal(
        u_ll,
        u_rr,
        orientation::Integer,
        equations::ShallowWaterTwoLayerEquations2D,
    ...
    formulation.
    """
    @inline function flux_es_fjordholm_etal(
        u_ll,
        u_rr,
        ...
        f_ec = flux_fjordholm_etal(u_ll, u_rr, orientation_or_normal_direction, equations)
    ...
    @inline function max_abs_speed_naive(
        ...
        # Calculate averaged velocity of both layers
        v_m_ll =
            (v_upper_dot_n_ll * h_upper_ll + v_lower_dot_n_ll * h_lower_ll) /
            (h_upper_ll + h_lower_ll)
        v_m_rr =
            (v_upper_dot_n_rr * h_upper_rr + v_lower_dot_n_rr * h_lower_rr) /
    ...
    @inline function max_abs_speeds(u, equations::ShallowWaterTwoLayerEquations2D)
        ...
        return (
            max(abs(v1_m) + c, abs(v1_upper), abs(v1_lower)),
    ...
    @inline function cons2entropy(u, equations::ShallowWaterTwoLayerEquations2D)
        ...
        w1 =
            rho_upper *
            (equations.gravity * (h_upper + h_lower + b) + -0.5 * (v1_upper^2 + v2_upper^2))
        w2 = rho_upper * v1_upper
        w3 = rho_upper * v2_upper
        w4 =
            rho_lower * (
                equations.gravity * (equations.r * h_upper + h_lower + b) +
    ...
    @inline entropy(cons, equations::ShallowWaterTwoLayerEquations2D) =
    ...
    @inline function energy_kinetic(u, equations::ShallowWaterTwoLayerEquations2D)
        ...
        return (
            0.5 * equations.rho_upper * h_v1_upper^2 / h_upper +
