...
@muladd begin
    ...
    struct ParsaniKetchesonDeconinck3Sstar94 <: SimpleAlgorithm3Sstar
        ...
        function ParsaniKetchesonDeconinck3Sstar94()
            gamma1 = SVector(
                0.0000000000000000E+00,
                -4.6556413837561301E+00,
                -7.7202649689034453E-01,
                -4.0244202720632174E+00,
                -2.1296873883702272E-02,
                -2.4350219407769953E+00,
                1.9856336960249132E-02,
                -2.8107894116913812E-01,
                1.6894354373677900E-01,
            )
            gamma2 = SVector(
                1.0000000000000000E+00,
                2.4992627683300688E+00,
                5.8668202764174726E-01,
                1.2051419816240785E+00,
                3.4747937498564541E-01,
                1.3213458736302766E+00,
                3.1196363453264964E-01,
                4.3514189245414447E-01,
            ...
            gamma3 = SVector(
                ...
                0.0000000000000000E+00,
                0.0000000000000000E+00,
                7.6209857891449362E-01,
                -1.9811817832965520E-01,
                -6.2289587091629484E-01,
                -3.7522475499063573E-01,
                -3.3554373281046146E-01,
                -4.5609629702116454E-02,
            )
            beta = SVector(
                2.8363432481011769E-01,
                9.7364980747486463E-01,
                3.3823592364196498E-01,
                -3.5849518935750763E-01,
                -4.1139587569859462E-03,
                1.4279689871485013E+00,
                1.8084680519536503E-02,
                1.6057708856060501E-01,
                2.9522267863254809E-01,
            )
            delta = SVector(
                1.0000000000000000E+00,
                1.2629238731608268E+00,
                7.5749675232391733E-01,
                5.1635907196195419E-01,
                -2.7463346616574083E-02,
                -4.3826743572318672E-01,
                1.2735870231839268E+00,
                -6.2947382217730230E-01,
                0.0000000000000000E+00,
            )
            c = SVector(
                0.0000000000000000E+00,
                2.8363432481011769E-01,
                5.4840742446661772E-01,
                3.6872298094969475E-01,
                -6.8061183026103156E-01,
                3.5185265855105619E-01,
                1.6659419385562171E+00,
                9.7152778807463247E-01,
    ...
    struct ParsaniKetchesonDeconinck3Sstar32 <: SimpleAlgorithm3Sstar
        ...
        function ParsaniKetchesonDeconinck3Sstar32()
            gamma1 = SVector(
                0.0000000000000000E+00,
                -1.2664395576322218E-01,
                1.1426980685848858E+00,
            )
            gamma2 = SVector(
                1.0000000000000000E+00,
                6.5427782599406470E-01,
            ...
            beta = SVector(
                7.2366074728360086E-01,
                3.4217876502651023E-01,
                3.6640216242653251E-01,
            )
            delta = SVector(
                1.0000000000000000E+00,
                7.2196567116037724E-01,
                0.0000000000000000E+00,
            )
            c = SVector(
                0.0000000000000000E+00,
    ...
    function solve(
        ...
        integrator = SimpleIntegrator3Sstar(
            ...
            ode.f,
            alg,
            SimpleIntegrator3SstarOptions(callback, ode.tspan; kwargs...),
            false,
        )
    ...
    get_tmp_cache(integrator::SimpleIntegrator3Sstar) =
