...
@muladd begin
    ...
    function ParametersEulerGravity(;
        ...
        background_density, gravitational_constant, cfl, resid_tol =
            promote(background_density, gravitational_constant, cfl, resid_tol)
    ...
    """
    struct SemidiscretizationEulerGravity{
        SemiEuler,
        SemiGravity,
        ...
        function SemidiscretizationEulerGravity{SemiEuler,SemiGravity,Parameters,Cache}(
            ...
            parameters::Parameters,
            cache::Cache,
        ) where {SemiEuler,SemiGravity,Parameters<:ParametersEulerGravity,Cache}
    ...
    """
    function SemidiscretizationEulerGravity(
        semi_euler::SemiEuler,
        semi_gravity::SemiGravity,
        parameters,
    ) where {
        ...
        SemiGravity<:SemidiscretizationHyperbolic{
            Mesh,
            <:AbstractHyperbolicDiffusionEquations,
        },
    }
    ...
    @inline function calc_error_norms(
        func,
        u,
        t,
        analyzer,
    ...
    function update_gravity!(semi::SemidiscretizationEulerGravity, u_ode)
        ...
        while !finalstep
            ...
            if n_iterations_max > 0 && iter >= n_iterations_max
                @warn "Max iterations reached: Gravity solver failed to converge!" residual =
                    maximum(abs, @views du_gravity[1, .., :]) t = t dt = dt
                finalstep = true
            end
    ...
    function timestep_gravity_carpenter_kennedy_erk54_2N!(
        cache,
        u_euler,
        t,
        dt,
    ...
    function timestep_gravity_3Sstar!(
        cache,
        u_euler,
        t,
        dt,
    ...
    function timestep_gravity_erk51_3Sstar!(
        cache,
        u_euler,
        t,
        dt,
        ...
        gamma1 = SVector(
            ...
            5.2910412316555866E-01,
            2.8433964362349406E-01,
            -1.4467571130907027E+00,
            7.5592215948661057E-02,
        )
        gamma2 = SVector(
            1.0000000000000000E+00,
            2.6366970460864109E-01,
            3.7423646095836322E-01,
            7.8786901832431289E-01,
        ...
        gamma3 = SVector(
            ...
            0.0000000000000000E+00,
            0.0000000000000000E+00,
            8.0043329115077388E-01,
            1.3550099149374278E-01,
        )
        beta = SVector(
            1.9189497208340553E-01,
            5.4506406707700059E-02,
            1.2103893164085415E-01,
            6.8582252490550921E-01,
            8.7914657211972225E-01,
        )
        delta = SVector(
            1.0000000000000000E+00,
            7.8593091509463076E-01,
            1.2639038717454840E-01,
            1.7726945920209813E-01,
            0.0000000000000000E+00,
        )
        c = SVector(
            0.0000000000000000E+00,
            1.9189497208340553E-01,
            1.9580448818599061E-01,
            2.4241635859769023E-01,
            5.0728347557552977E-01,
        )
    ...
    function timestep_gravity_erk52_3Sstar!(
        cache,
        u_euler,
        t,
        dt,
        ...
        gamma1 = SVector(
            0.0000000000000000E+00,
            5.2656474556752575E-01,
            1.0385212774098265E+00,
            3.6859755007388034E-01,
            -6.3350615190506088E-01,
        )
        gamma2 = SVector(
            1.0000000000000000E+00,
            4.1892580153419307E-01,
            -2.7595818152587825E-02,
            9.1271323651988631E-02,
        ...
        gamma3 = SVector(
            ...
            0.0000000000000000E+00,
            0.0000000000000000E+00,
            4.1301005663300466E-01,
            -5.4537881202277507E-03,
        )
        beta = SVector(
            4.5158640252832094E-01,
            7.5974836561844006E-01,
            3.7561630338850771E-01,
            2.9356700007428856E-02,
            2.5205285143494666E-01,
        )
        delta = SVector(
            1.0000000000000000E+00,
            1.3011720142005145E-01,
            2.6579275844515687E-01,
            9.9687218193685878E-01,
            0.0000000000000000E+00,
        )
        c = SVector(
            0.0000000000000000E+00,
            4.5158640252832094E-01,
            1.0221535725056414E+00,
            1.4280257701954349E+00,
    ...
    function timestep_gravity_erk53_3Sstar!(
        cache,
        u_euler,
        t,
        dt,
        ...
        gamma1 = SVector(
            0.0000000000000000E+00,
            6.9362208054011210E-01,
            9.1364483229179472E-01,
            1.3129305757628569E+00,
            -1.4615811339132949E+00,
        )
        gamma2 = SVector(
            1.0000000000000000E+00,
            1.3224582239681788E+00,
            2.4213162353103135E-01,
            -3.8532017293685838E-01,
        ...
        gamma3 = SVector(
            ...
            0.0000000000000000E+00,
            0.0000000000000000E+00,
            3.8306787039991996E-01,
            -3.5683121201711010E-01,
        )
        beta = SVector(
            8.4476964977404881E-02,
            3.0834660698015803E-01,
            3.2131664733089232E-01,
            2.8783574345390539E-01,
            8.2199204703236073E-01,
        )
        delta = SVector(
            1.0000000000000000E+00,
            -7.6832695815481578E-01,
            1.2497251501714818E-01,
            1.4496404749796306E+00,
            0.0000000000000000E+00,
        )
        c = SVector(
            0.0000000000000000E+00,
            8.4476964977404881E-02,
            2.8110631488732202E-01,
            5.7093842145029405E-01,
            7.2999896418559662E-01,
        )
    ...
    @inline function save_solution_file(
        u_ode,
        t,
        dt,
        iter,
        ...
        filename_euler = save_solution_file(
            u_euler,
            t,
            dt,
            iter,
        ...
        filename_gravity = save_solution_file(
            u_gravity,
            t,
            dt,
            iter,
    ...
    @inline function (amr_callback::AMRCallback)(
        u_ode,
        semi::SemidiscretizationEulerGravity,
        t,
        iter;
