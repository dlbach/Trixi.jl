...
@muladd begin
    ...
    function SemidiscretizationHyperbolicParabolic(
        ...
        return SemidiscretizationHyperbolicParabolic(
            mesh,
    ...
    function SemidiscretizationHyperbolicParabolic(
        ...
        _boundary_conditions_parabolic =
            digest_boundary_conditions(boundary_conditions_parabolic, mesh, solver, cache)
    ...
    @inline nvariables(semi::SemidiscretizationHyperbolicParabolic) =
    ...
    function rhs_parabolic!(du_ode, u_ode, semi::SemidiscretizationHyperbolicParabolic, t)
        ...
        # TODO: Taal decide, do we need to pass the mesh?
        time_start = time_ns()
        @trixi_timeit timer() "parabolic rhs!" rhs_parabolic!(
            du,
            u,
            t,
            mesh,
