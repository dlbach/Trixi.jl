...
@muladd begin
    ...
    mutable struct VisualizationCallback{
        SolutionVariables,
        VariableNames,
        PlotDataCreator,
        PlotCreator,
    ...
    function Base.show(
    ...
    ) where {Condition,Affect!<:VisualizationCallback}
        ...
        show_mesh,
        plot_creator,
        plot_data_creator = visualization_callback
        print(
            io,
    ...
    function VisualizationCallback(;
        ...
        DiscreteCallback(
            ...
            visualization_callback, # the first one is the condition, the second the affect!
    ...
    function (visualization_callback::VisualizationCallback)(integrator)
        u_ode = integrator.u
        semi = integrator.p
        @unpack plot_arguments,
        solution_variables,
        variable_names,
        show_mesh,
        plot_data_creator,
        plot_creator = visualization_callback
