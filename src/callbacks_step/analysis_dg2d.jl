...
@muladd begin
    ...
    function create_cache_analysis(
        ...
        jacobian_tmp1 =
            StrideArray(undef, RealT, StaticInt(nnodes(analyzer)), StaticInt(nnodes(dg)))
    ...
    function calc_error_norms(
        ...
        @unpack u_local, u_tmp1, x_local, x_tmp1, jacobian_local, jacobian_tmp1 =
            cache_analysis
    ...
    function analyze(
        ...
        integrate_via_indices(
            ...
            cache,
            du,
        ) do u, i, j, element, equations, dg, du
    ...
    function analyze(
        ...
        ) do u, i, j, element, equations, dg, cache, derivative_matrix
            divb = zero(eltype(u))
            for k in eachnode(dg)
                divb += (
                    derivative_matrix[i, k] * u[6, k, j, element] +
    ...
    function analyze(
        ...
        integrate_via_indices(
            ...
            for k in eachnode(dg)
                divb += (
                    derivative_matrix[i, k] * u[5, k, j, element] +
