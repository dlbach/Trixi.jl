...
@muladd begin
    ...
    function StepsizeCallback(; cfl::Real = 1.0)
        ...
        DiscreteCallback(
            stepsize_callback,
            stepsize_callback, # the first one is the condition, the second the affect!
    ...
    function initialize!(
        ...
        t,
        integrator,
    ) where {Condition,Affect!<:StepsizeCallback}
    ...
    @inline function (stepsize_callback::StepsizeCallback)(integrator)
        ...
        if !integrator.opts.adaptive
            ...
            dt = @trixi_timeit timer() "calculate dt" cfl_number * max_dt(
                u,
                t,
                mesh,
