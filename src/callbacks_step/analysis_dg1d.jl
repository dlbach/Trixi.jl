...
@muladd begin
    ...
    function create_cache_analysis(
        ...
        jacobian_local = StrideArray(undef, RealT, StaticInt(nnodes(analyzer)))
        ...
        for element in eachelement(dg, cache)
            ...
            for i in eachnode(analyzer)
                u_exact = initial_condition(
                    get_node_coords(x_local, equations, dg, i),
                    t,
                    equations,
                )
                diff =
    ...
    function analyze(
        ...
        integrate_via_indices(
            ...
            cache,
            du,
        ) do u, i, element, equations, dg, du
    ...
    function analyze(
        ...
        ) do u, i, element, equations, dg, derivative_matrix
            divb = zero(eltype(u))
