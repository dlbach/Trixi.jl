...
@muladd begin
    ...
    function calc_error_norms(
        ...
        l2_errors, linf_errors = calc_error_norms_per_element(
            func,
            u,
            t,
            analyzer,
    ...
    function calc_error_norms_per_element(
        func,
        u,
        t,
        analyzer,
    ...
    function integrate_via_indices(
        ...
        integral = zero(
            func(
                zero(SVector{nvariables(equations),eltype(u)}),
                1,
                1,
                1,
                equations,
