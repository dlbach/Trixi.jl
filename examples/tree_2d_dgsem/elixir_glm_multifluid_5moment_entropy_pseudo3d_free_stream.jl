...
function initial_condition_constant(x, t, equations::Trixi.GlmMultiFluid5MomentPlasmaEquationsEntropyPseudo3D)
...
equation = Trixi.GlmMultiFluid5MomentPlasmaEquationsEntropyPseudo3D((1.6, 1.6), (1.0, 1.0), (1.0, -1.0), 1e2, 1e-2, 1e0)
mesh = TreeMesh((-1.0, -1.0), (1.0, 1.0), periodicity = true, 
